...
-- Find those person who earn more than average salary.

SELECT * FROM users 
	WHERE salary > (SELECT AVG(salary) FROM users);
    
-- Find those person who earn less than average salary

SELECT * FROM users
	WHERE salary < (SELECT AVG(salary) FROM users);
    
-- Find id and name who is referred by those person those salary is greater than 50000.
