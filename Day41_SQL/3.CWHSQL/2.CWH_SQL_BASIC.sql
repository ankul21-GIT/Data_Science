...
-- Find those name who born before 1995.
SELECT *
FROM users
...
-- Find the only male and female gender.

SELECT * FROM users WHERE gender IN('Male','Female');


-- Find out the female and those salary is above than 70000.
