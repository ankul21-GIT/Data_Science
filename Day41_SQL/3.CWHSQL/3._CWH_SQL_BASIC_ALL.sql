...
-- Update the salary and email of id 1.

UPDATE users 
SET salary = 45000, email = 'aarav@aarav.com'
WHERE id = 1;

-- Update the salary of id 5 and put it into 70,000;
...
-- Change name aisha to aisha khan.
...
-- Incrase salary by 10000 whose salary is less than 60000.
...
-- DELETE those name whose salary is less than 65000
