...
SELECT price, price / 100 AS discounted_price FROM products; 


SELECT price, price / 100 * 10 AS discounted_price FROM products; 

SELECT * FROM products WHERE price = 19.99;

SELECT * FROM products WHERE price > 20.99;

SELECT * FROM products WHERE price BETWEEN 10 AND 30;

SELECT * FROM products 
WHERE created_at 
BETWEEN '2025-02-11' AND '2025-02-12';

SELECT * FROM products WHERE product_id IN (1,4);
